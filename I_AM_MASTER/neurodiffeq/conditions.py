...
class BC2IV2(BaseCondition):
    ...
    def enforce(self, net, x, t):
        ...
        if self.x_min_val and self.x_max_val and self.t_min_prime:
            ...
            uxt0 = ANN(x, t0)
            return self.parameterize(uxt, x, t, uxt0, t0)
    ...
    def _parameterize_dd(self, uxt, x, t, x_tilde, t_tilde, t0):
        Axt = self.t_min_val(x) + \
              ...
              ((1 - x_tilde) * self.t_min_val(0) + x_tilde * self.t_min_val(self.x_max)) + \
              t * (self.t_min_prime(x) - ((1 - x_tilde) * self.t_min_prime(self.x_min) + x * self.t_min_prime(self.x_max)))
